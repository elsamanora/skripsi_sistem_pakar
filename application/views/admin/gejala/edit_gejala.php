                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group-inner">
                                                    ...
                                                    <input type="text" name="nama_gejala" class="form-control form-control-sm <?php echo form_error('nama_gejala') ? 'is-invalid':''?>" placeholder="Masukkan Nama Gejala" value = "<?php echo $gejala ->nama_gejala?>" required>
                                                </div>
                                                <div class="invalid-feedback">
